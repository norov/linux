...
#if defined(CONFIG_MIGRATION) && defined(CONFIG_64BIT)
#define IF_HAVE_PG_DEMOTE(flag,string) ,{1UL << flag, string}
#else
#define IF_HAVE_PG_DEMOTE(flag,string)
#endif
...
IF_HAVE_PG_DEMOTE(PG_demote,		"demote"	)
