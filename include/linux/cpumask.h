 ...
 * @src2p: the second cpumask pointer
 *
 * Return: next set bit or >= nr_cpu_ids if no cpus set in both cpumasks.
 */
static __always_inline
...
/*
 * cpumask_next_wrap - get the next cpu in *src, starting from @n. If nothing
 *		       found, wrap around and start from the beginning
 * @n: the cpu prior to the place to search
 * @src: cpumask pointer
 *
 * Return: next set bit or >= nr_cpu_ids if no cpus set in the cpumask.
 */
static __always_inline
