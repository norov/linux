...
Passing parameters in wrong order is a common source of bugs. Listing parameters
in standard widely adopted order helps to avoid confusion.
...
example is the ``GENMASK(high, low)`` macro. While such notation is popular
